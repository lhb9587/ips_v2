...
import { queryBillInternalListUrl } from "@/api/billApi";
import { saveTableConfig,formatAmount } from "@/utils"
...
const bussId = 9;
const gridName = "internalBillListGrid"
...
const billinterid = ref("");
const isBillDetail = ref(false);
const toggleSidebar = (params) => {
  const id = params.data.billinterid;
  if (id) {
    billinterid.value = id;
