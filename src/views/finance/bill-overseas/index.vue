...
import { queryAbroadList } from "@/api/billApi";
...
const bussId = 16;
const gridName = "abroadBillListGrid"
...
const toggleSidebar = (params) => {
  const id = params.data.abroadBillId;
  if(id){
    billId.value = id;
...
const cellRenderer = (params) => {
  ...
  if (formatValueList.includes(params.colDef.field)) {
