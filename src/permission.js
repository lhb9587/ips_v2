...
const allowRouterList = ['personal-profile','contract-detail','project-detail','task-detail','subtask-detail','case-detail','leave-quota-management','leave-management','my-leave-application','my-leave-list']
// 记录路由
// let hasRoles = true
