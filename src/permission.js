...
const allowRouterList = ['personal-profile','contract-detail','project-detail','task-detail','subtask-detail','case-detail','leave-quota-management','leave-management','supplement-management','attendance-profile','my-leave-application','my-leave-list','my-leave-detail','my-supplement-application','my-supplement-list','my-supplement-detail']
// 记录路由
// let hasRoles = true
