<template>
  ...
  <div class="card">
    <div class="card-body">
      <h4 class="card-title mb-2">我方当事人</h4>
      <div class="table-responsive">
        <el-table
          :data="caseInfo.agentPartyArray"
          max-height="200"
          :fit="true"
        ...
        >
          <el-table-column
            :prop="col.value"
            :label="col.title"
            v-for="col of partyColumns"
            :key="col.value"
          >
            <template #default="scope">
              <span v-if="col.value === 'position'">{{
                transformation(
                  selectDataByClass["1027"],
                  scope.row.position,
                  "id",
                  "typeName"
                )
  ...
  <div class="card">
    <div class="card-body">
      <h4 class="card-title mb-2">对方当事人</h4>
      <div class="table-responsive">
        <el-table
          :data="caseInfo.adversaryArray"
          max-height="200"
          :fit="true"
          :show-overflow-tooltip="true"
        >
  ...
  <div class="card">
    <div class="card-body">
      <h4 class="card-title mb-2">其他当事人</h4>
      <div class="table-responsive">
        <el-table
          :data="caseInfo.otherPartyArray"
          max-height="200"
          :fit="true"
          :show-overflow-tooltip="true"
        >
