...
const changeBorder = (newVal) => {
  ...
  saveTableConfig("isBorderline",props.gridName,newVal)
};
const changeRowStyle = (newVal) => {
  ...
  saveTableConfig("iszebra",props.gridName,newVal)
};
//密度
const rowHeight = ref(40);
const changeRowHeight = (height) => {
  rowHeight.value = height;
  saveTableConfig("rowHeight",props.gridName,height)
};
